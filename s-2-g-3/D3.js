...
*/
for(let i2= 0; i2 < starWarsCharacters.length; i2++){
  characters.push(starWarsCharacters[i2].name);
}
...
for(let i3= 0; i3 < starWarsCharacters.length; i3++){
  risultato = starWarsCharacters[i3];
  if (risultato.gender == "female"){
    femaleCharacters.push(risultato)
  }
}
...
for(let i5= 0; i5 < starWarsCharacters.length; i5++){
  chara = starWarsCharacters[i5]
}
switch (chara.eyeColor){
  case "blue": 
  eyeColor.blue.push(chara)
  break
  case "yellow":
  eyeColor.yellow.push(chara)
    break
  case "brown":
    eyeColor.brown.push(chara)
    break
  case "red":
    eyeColor.red.push(chara)
    break
  case "blue_gray":
    eyeColor.bluegray.push(chara)
    break
}
...
*/
let crewMass2 = 0
for(let i6= 0; i6 < starWarsCharacters.length; i6++){
...
*/
for (let i8 = 0; i8 < starWarsCharacters.length; i8++) {
  const currentCharacter = starWarsCharacters[i8];
